...
exports.KanbanAppTrigger = void 0;
const n8n_workflow_1 = require("n8n-workflow");
const GenericFunctions_1 = require("./GenericFunctions");
class KanbanAppTrigger {
    constructor() {
        this.description = {
    ...
    async trigger() {
        const eventTypes = this.getNodeParameter('eventTypes', 0, []) || [];
        const pollInterval = this.getNodeParameter('pollInterval', 0, 15);
        const initialLookback = this.getNodeParameter('initialLookback', 0, 10);
        const syncLimit = this.getNodeParameter('syncLimit', 0, 100);
        let lastEventId;
        let active = true;
        let polling = false;
            ...
            try {
                ...
                if (Array.isArray(events) && events.length > 0) {
                    ...
                    if (filtered.length > 0) {
                        const executionItems = filtered.map((event) => ({
                            json: event,
                        }));
...
exports.KanbanAppTrigger = KanbanAppTrigger;
//# sourceMappingURL=KanbanAppTrigger.node.js.map